...
public class CheckOut1Test extends BaseTest {
    ...
    @Test(description = "Verify_Shippingmethod_and_PaymentMethod_Functionality")
   ...
   @Test(description = "Verify_ThatUserCanChooses_CreditCardType")
    public void Verify_ThatUserCanChooses_CreditCardType(){
        driver.get("https://demowebshop.tricentis.com/login");
        LoginPage loginPage = new LoginPage(driver);
        loginPage.loginFunction();
        HomePage homePage = new HomePage(driver);
        ...
        checkoutPage1.changeMonth();
        checkoutPage1.changeYear();
        checkoutPage1.CardCodeField("12345");
        checkoutPage1.continuePaymentInfo();
    }

    @Test(description = "Verify_PurchaseOrderNumber")
